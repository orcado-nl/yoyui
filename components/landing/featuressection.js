            ...
            <div className=" mt-7 px-3 lg:px-8">
                <div className="features-container">
                    <div className="grid">
                        ...
                        <div className="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div className="box p-4 w-full animation-duration-500">
                                <img src="/images/landing-new/features/icon-theme.svg" alt="components icon" className="block mb-3" />
                        ...
                        <div className="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div className="box p-4 w-full animation-duration-500">
                                <img src="/images/landing-new/features/icon-community.svg" alt="components icon" className="block mb-3" />
                        ...
                        <div className="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div className="box p-4 w-full animation-duration-500">
                                <img src="/images/landing-new/features/icon-accessibility.svg" alt="components icon" className="block mb-3" />
                        ...
                        <div className="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div className="box p-4 w-full animation-duration-500">
                                <img src="/images/landing-new/features/icon-support.svg" alt="components icon" className="block mb-3" />
                        ...
                        <div className="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div className="box p-4 w-full animation-duration-500">
                                <img src="/images/landing-new/features/icon-mobile.svg" alt="components icon" className="block mb-3" />
                        ...
                        <div className="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div className="box p-4 w-full animation-duration-500">
                                <img src="/images/landing-new/features/icon-productivity.svg" alt="components icon" className="block mb-3" />
                        ...
                        <div className="col-12 md:col-6 xl:col-3 flex justify-content-center">
                            <div className="box p-4 w-full animation-duration-500">
                                <img src="/images/landing-new/features/icon-ts.svg" alt="components icon" className="block mb-3" />
