    ...
    return (
        <DocSectionText id="accessibility" label="Accessibility">
            ...
            <p>
                ...
                <i>chooseDate</i>
                key of the aria property from the <Link href="/locale">locale</Link> API. This label is also used for the <i>aria-label</i> of the popup as well. When there is a value selected, it is formatted and appended to the label to be able to
