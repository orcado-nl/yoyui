...
function renderSonarNested1(headerRef, message, contentRef, footerRef, hide, accept, reject) {
    return (
...
export function HeadlessDoc(props) {
    ...
    const confirm1 = () => {
        confirmDialog({ group: 'headless', message: 'Are you sure you want to proceed?', header: 'Confirmation', icon: 'pi pi-exclamation-triangle', defaultFocus: 'accept', accept, reject });
    };
...
export default function HeadlessDemo() {
    ...
    return (
        <div>
            ...
            <Toast ref={toast} />
            <ConfirmDialog group="headless" content={({ headerRef, contentRef, footerRef, hide, message }) => renderSonarNested1(headerRef, message, contentRef, footerRef, hide, accept, reject)} />
            <div className="card flex flex-wrap gap-2 justify-content-center">
