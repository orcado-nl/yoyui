...
function renderSonarNested1(props, clear) {
    return (
...
export function TemplateDoc(props) {
    ...
    const confirm = () => {
        if (!visible) {
            setVisible(true);
            toastBC.current.clear();
            toastBC.current.show({ severity: 'success', summary: 'Can you send me the report?', sticky: true, content: (props) => renderSonarNested1(props, clear) });
        }
    };
