...
import './assets/theme.css';
    ...
    return (
        <DocSectionText {...props}>
            ...
            <h3>Theme SCSS</h3>
            <p>
                The theme scss is available as open source at <a href="https://github.com/primefaces/primereact-sass-theme">primereact-sass-theme</a> repository. The <i>theme-base</i> folder contains the theming structure of the components, themes
                under <i>themes</i> folder import the base and define the SCSS variables. The <i>themes</i> folder also contains all the built-in themes so you can customize their code as well.
            </p>
            <p>
                To create your own theme, <a href="https://github.com/primefaces/primereact-sass-theme/releases">download</a> the release matching your PrimeReact version and access the <i>themes/mytheme</i> folder. The sass variables to customize
                are available under the <i>variables</i> folder. The <i>_fonts</i> file can be used to define a custom font for your project whereas the optional <i>_extensions</i> file is provided to add overrides to the components designs. The{' '}
            ...
            <p>
                ...
                assets reside. At a suitable entry point like <i>_app.js</i> or <i>index.js</i>, import the <i>theme.scss</i> from <i>assets/themes/mytheme</i>. That would be it, during build time, your project will compile the sass and import the
