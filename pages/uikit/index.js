                ...
                <div className="card mb-5" style={{ borderRadius: '50px' }}>
                    ...
                    <div className="flex flex-column md:flex-row align-items-center gap-4 md:gap-8">
                        <div className="w-full md:w-6">
                            ...
                            <p className="mb-3 text-lg">Empower yourself with unprecedented control over your designs. Tokens Studio integration unlocks a whole new level of flexibility, allowing you to create and manage design tokens seamlessly.</p>
                    ...
                    <div className="grid">
                        ...
                        <div className="col-12 lg:col-4 px-2 lg:px-5">
                            ...
                            <p className="mt-0 mb-6 p-0 line-height-3 text-lg">
                                ...
                                Users can seek assistance in our community via our public{' '}
