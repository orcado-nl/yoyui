        ...
        },
        {
            ...
            content: (
                <div className="video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/3pO79DdPpiU" style={{ border: 0 }} allowFullScreen title="Scoped CSS with YoYui" />
                </div>
            ),
            children: [
                {
